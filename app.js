...
function multiplyArray(multArr) {
   let multiplyaelementofarray =1;
  for(let j=0;j<multArr.length;j++){
    multiplyaelementofarray=multiply(multiplyaelementofarray,multArr[j])[0];
     // console.log(multiplyaelementofarray);
  }
return[multiplyaelementofarray,`The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${multiplyaelementofarray}.`];
}
...
Test this function by hand in the console to get it working, and when you think it is finished, uncomment the call for 
the testMultiplyAnyArray() function and see if the test passes.*/
...
function multiplyAnyArray(dynamicArray) {
  ...
  let multiplydynamicarray=1;
    for(let c=0;c<dynamicArray.length;c++){
      multiplydynamicarray=multiply(multiplydynamicarray,dynamicArray[c])[0];
 
    }

    return[multiplydynamicarray,`The numbers ${dynamicArray[0]}, ${dynamicArray[1]}, ${dynamicArray[2]}, ${dynamicArray[3]}, ${dynamicArray[4]} have a product of ${multiplydynamicarray}.`]
  }
// Here is the test for multiplyArray(); uncomment it to run it
